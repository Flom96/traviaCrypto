    ...
    <link href="/css/profile.css" rel="stylesheet">
    	<div class="page-titles-img title-space-lg parallax-overlay bg-parallax" data-jarallax='{"speed": 0.4}' style='background-image: url("/images/bg13.jpg");background-position:top center;'>
            <div class="container">
                <div class="row">
                    <div class=" col-md-12">
                        <h1 class="text-uppercase">Account Settings</h1>
    	...
    	<div class="container emp-profile">
            <form method="post">
                <div class="row">
                    ...
                    <div class="col-md-2">
                        <input type="button" class="profile-edit-btn" style="background-color: #42cd65; color: #fff;width:100% !important" onclick="window.location.href = '/editProfile'" name="" value="Edit Profile"/><br>
                    </div>
                </div>
            </form>
                <div class="row">
                            ...
                            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                <form method="post" action="/updatePassword">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <p><input type="password" name="old_password" value="" class="edit-profile" required></p>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                            <p><input type="password" name="new_password" value="" class="edit-profile" required></p>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                            <p><input type="password" name="password_confirmation" value="" class="edit-profile" required></p>
                                        </div>
                                    </div>
