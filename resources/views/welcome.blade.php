@extends('layout.navbar')
    @section('content')
            ...
            <div id="rev_slider_1078_1" class="rev_slider fullwidthabanner" style="display:none;" data-version="5.4.1">
                <ul>	
                    ...
                    <li data-index="rs-3045" data-transition="parallaxtoleft" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut" data-masterspeed="2000" data-rotate="0"  data-fstransition="fade" data-fsmasterspeed="1500" data-fsslotamount="7" data-saveperformance="off"  data-title="Intro" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                        <!-- MAIN IMAGE -->
                        <img src="images/t1.jpg"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg" data-no-retina>
                        <!-- LAYERS -->
                        <!-- LAYER NR. 1 -->
                        <div class="tp-caption mainSlide-Subtitle   tp-resizeme" 
                             ...
                             style="z-index: 7; white-space: nowrap;text-transform:left;">Maecenas non nisl ligula</div>
                        <!-- LAYER NR. 1 -->
                        <div class="tp-caption mainSlide-Title-Centered   tp-resizeme" 
                             ...
                             data-paddingleft="[0,0,0,0]"
                             style="z-index: 6; text-align:left; max-width:1170px; white-space: normal;">Lorem ipsum dolor sit amet</div>
                        <!-- LAYER NR. 3 -->
                    ...
                    <li data-index="rs-3046" data-transition="parallaxtoleft" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut" data-masterspeed="2000" data-rotate="0"  data-fstransition="fade" data-fsmasterspeed="1500" data-fsslotamount="7" data-saveperformance="off"  data-title="Intro" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                        <!-- MAIN IMAGE -->
                        <img src="images/t2.jpg"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg" data-no-retina>
                        <!-- LAYERS -->
                        ...
                        <div class="tp-caption mainSlide-Title-Centered   tp-resizeme" 
                             ...
                             style="z-index: 6; text-align:center; white-space: normal;">consectetur adipiscing elit</div>
                        <!-- LAYER NR. 3 -->
                        <div class="tp-caption mainSlide-caption   tp-resizeme" 
                             ...
                             data-paddingbottom="[10,10,10,10]"
                             data-paddingleft="[0,0,0,0]"
                             style="z-index: 6; text-align:left; max-width:1170px; white-space: normal;">Duis rhoncus posuere augue nec ullamcorper Duis rhoncus posuere augue nec ullamcorper</div>
                    </li>
                    <!-- SLIDE  -->
                    <li data-index="rs-3047" data-transition="parallaxtoright" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut" data-masterspeed="2000" data-rotate="0"  data-saveperformance="off"  data-title="HTML5 Video" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                        <!-- MAIN IMAGE -->
                        <img src="images/t3.jpg"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgparallax="10" class="rev-slidebg" data-no-retina>
                        <!-- LAYERS -->
                        ...
                        <div class="tp-caption mainSlide-Title-Centered   tp-resizeme" 
                             ...
                             style="z-index: 6; text-align:center; white-space: normal;">Sed imperdiet et tortor</div>
                        <!-- LAYER NR. 3 -->
                        <div class="tp-caption mainSlide-caption   tp-resizeme" 
                             ...
                             data-paddingbottom="[10,10,10,10]"
                             data-paddingleft="[0,0,0,0]"
                             style="z-index: 6; text-align:left; max-width:1170px; white-space: normal;">Nunc commodo aliquam neque vel sagittis</div>
                    </li>
                </ul>
        ...
        <div class="bg-parallax parallax-overlay" data-jarallax='{"speed": 0.2}' style='background-image: url("images/bg6.jpg")'>
            <div class="container pt60 pb60">
                <div class="row">
                    <div class="col-lg-8">
                        <h3 class="text-white">
                            Sed ullamcorper sapien nec nisl consectetur 
                        </h3>
                    </div>
        ...
        <div class="pt90 pb50 container">
            <div class="title-heading1 mb40">
                <h3>ac nisi vulputate fringilla</h3>
            </div>
            <div class="row">
                <div class="col-lg-4 mb40">
                    <div class="media icon-simple">
                        ...
                        <div class="media-body">
                            <h4 class="mt-0 mb10">felis euismod</h4>
            ...
            <div class="container pt90 pb60">
                <div class="row align-items-center">
                    <div class="col-lg-6 mb30">
                        <h3 class="text-white mb30">About Us</h3>
                    ...
                    <div class="col-lg-3 mb30 text-center">
                        ...
                        <h4 class="pt30 text-white">felis euismod</h4>
                    </div>
        ...
        <div class="container pt90 pb60">
            <div class="row align-items-center">
                <div class="col-lg-5 mb30">
                    ...
                    <div class="clearfix">
                        <p>
                            Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.Suspendisse potenti. Praesent cursus ipsum a fermentum molestie. Fusce lorem purus, rhoncus elementum ultrices et, pharetra in ex. Mauris commodo in nisi ac pharetra. Nulla in eros pellentesque, condimentum dolor sit amet
                        </p>
                ...
                <div class="col-lg-6 ml-auto mb30">
                    <h3 class="mb20">How it works</h3>
                    <p>
                    Vestibulum eu interdum ante, et scelerisque nulla. Mauris nisl est, elementum porttitor dignissim ac, mattis quis nisl. Etiam maximus sed mi id sagittis. Suspendisse potenti. Praesent cursus ipsum a fermentum molestie. Fusce lorem purus, rhoncus elementum ultrices et, pharetra in ex. Mauris commodo in nisi ac pharetra. Nulla in eros pellentesque, condimentum dolor sit amet,
                    </p>
                    ...
                    <div class="col-lg-6 mr-auto ml-auto">
                        <form action="/contact" role="form" method="post">
                            <div class="">
                                ...
                                <textarea class="form-control required" name="message" placeholder="Enter Message" required></textarea><br>
